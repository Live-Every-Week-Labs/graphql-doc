import { DocModel, Section, Subsection, Operation, ExpandedType } from '../../transformer/types.js';
import { slugify } from '../../utils/string-utils.js';
import { groupTypes } from '../../utils/index.js';
...
export class SidebarGenerator {
  ...
  private generateSinglePageOperationItem(operation: Operation, docId: string): SidebarItem {
    ...
    const label =
      operation.directives.docGroup?.displayLabel ??
      operation.directives.docGroup?.sidebarTitle ??
      operation.name;
    return {
      type: 'link',
      label,
  ...
  private generateTypeCategories(types: ExpandedType[]): SidebarItem[] {
    const typeGroups = groupTypes(types);
